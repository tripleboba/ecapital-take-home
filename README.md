...
- [ ] Ability to edit the employee information [FAIL]
- [x] Ability to delete the employee
- [x] Ability to add or create a new employee with a first name, last name, and salary

### Guidelines ###
- [x] Structure your application and components in a modular/reusable way [have tried my best]
- [x] Commit code with useful and informative comments [have tried my best]
